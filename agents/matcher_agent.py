...
class MatcherAgent(BaseAgent): 
  def __init__(self):
    super().__init__(
      ...
      Consider : skills match, experience level, location preference.
      Provide detailed reasoning and compatibilty scores.
  ...
  async def run(self, messages:list)  -> Dict[str, Any]: 
    """Match candidate with avaialble positions""" 
    ...
    if not skills_analysis:
      print("No skills analysis provided i the input.")
      return {
        "matched_jobs": [],
    ...
    matchig_jobs =  self.search_jobs(skills, experience_level)
